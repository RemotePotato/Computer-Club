                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input type="text" placeholder="Ajax Inc." class="form-control" pattern="[A-Za-z\- ]{2,}" title="Alphabetic, @ and - symbols only. E.g. - John" required="required">
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <label><span style="color:red;">*</span>Collaborator Type</label>
                                        </br>
                                        </br>
                                        <input type="radio" name="collab_type" value="1" required="required" /> Company &nbsp;
                                        <input type="radio" name="collab_type" value="2" /> Individual
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6 form-group">
